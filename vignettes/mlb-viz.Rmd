...
[baseballr](https://billpettitt.github.io/baseballr/) for player and team data with
...
baseballr's MLB Stats API and Baseball Savant functions identify players by
their MLBAM ID, not their ESPN athlete ID, which is why the headshots above pass
`id_type = "league"`: it draws MLBAM IDs from MLB's own image CDN. Leave
`id_type` unset for ESPN athlete IDs, such as those in baseballr's `espn_mlb_*()`
...
- Explore [baseballr documentation](https://billpettitt.github.io/baseballr/)
