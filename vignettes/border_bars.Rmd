...
Awesome! Now we have our data. Let's throw it over to `gt`. To create row groups in `gt`, remember to pass in your data *grouped by* that category. For this table, we are using several functions from `sdvplotR`: 
