---
title: "Social Posting Patterns with sdvplotR"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Social Posting Patterns with sdvplotR}
...
This vignette demonstrates best practices for creating shareable sports graphics
using sdvplotR. These patterns are optimized for social media platforms like
...
1. **Aspect Ratios**: Use platform-specific aspect ratios (16:9 for Twitter, 1:1 for Instagram posts, 9:16 for Stories)
