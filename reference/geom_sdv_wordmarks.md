...
This geom is used to plot sports team wordmarks instead of points in a
...
`geom_sdv_wordmarks()` understands the following aesthetics (required
...
- `width = 1.0`:
  ...
  \- The desired width of the image in `npc`. A typical size is
  `width = 0.12`.
